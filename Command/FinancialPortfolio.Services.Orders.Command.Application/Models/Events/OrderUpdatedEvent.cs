...
namespace FinancialPortfolio.Services.Orders.Command.Application.Models.Events
{
    ...
    public record OrderUpdatedEvent : IEvent
    {
        ...
        public OrderUpdatedEvent(Guid id, int version, OrderType type, double amount, decimal price, DateTime dateTime, decimal commission, Guid assetId, Guid accountId)
        {
            Id = id;
            Version = version;
            Type = type;
